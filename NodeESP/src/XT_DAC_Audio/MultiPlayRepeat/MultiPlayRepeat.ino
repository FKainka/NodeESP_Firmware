...
XT_MultiPlay_Class Sequence;                // The sequence object, you add your sounds above to this object (see setup below)
...
void loop() {
  ...
  if(Sequence.Playing==false)               // If not playing, play it! At first it won't be so starts it off as well
