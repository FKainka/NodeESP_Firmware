...
XT_MusicScore_Class Music(TwinkleTwinkle,TEMPO_ALLEGRO,INSTRUMENT_PIANO,0);    // Music score object, handles tunes. Pass Music Data,Tempo, Instrument and no of repeats (0 = infinite)
