...
void btn_exmpl(){  //Teste 2 Buttons mit UDP und MQTT
        dflt_init();
        udp_init();
        mqtt_init();
...
void touch_exmpl(){  //Teste 2 Buttons mit UDP und MQTT
        dflt_init();
        udp_init();
        mqtt_init();
...
void led_exmpl(){  //Teste 2 Buttons mit UDP und MQTT
        dflt_init();
        udp_init();
        mqtt_init();
...
void pwm_exmpl(){  //Teste 2 Buttons mit UDP und MQTT
        dflt_init();
        udp_init();
        mqtt_init();
...
void adc_exmpl(){  //Teste 2 Buttons mit UDP und MQTT
        dflt_init();
        udp_init();
        mqtt_init();
